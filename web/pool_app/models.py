...
class PoolTagAnswer(models.Model):
    answer_id = models.IntegerField(primary_key=True)
    pool_tag = models.ForeignKey('PoolTagMaster', db_column='pool_tag')
    option_selected = models.CharField(max_length=10)
    option_text = models.TextField()
    user = models.ForeignKey('PoolUsers')
...
class PoolTagMaster(models.Model):
    pool_id = models.IntegerField(unique=True)
    pool_tag = models.CharField(primary_key=True, max_length=100)
