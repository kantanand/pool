...
create table if not exists pool_tag_master (
	...
	option1_count INT UNSIGNED NOT NULL DEFAULT 0,
	option2_count INT UNSIGNED NOT NULL DEFAULT 0,
	option3_count INT UNSIGNED NOT NULL DEFAULT 0,
	option4_count INT UNSIGNED NOT NULL DEFAULT 0,
    unique (pool_id),
...
create table if not exists pool_tag_answer(
	...
	CONSTRAINT pool_tag_user_answered FOREIGN KEY (user_id) REFERENCES pool_users(user_id),
